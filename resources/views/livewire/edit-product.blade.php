        ...
        <div class="w-full">
                <div class="py-3 mb-4 text-black text-sm">
                    <ul class="flex">
                        ...
                        <li><span class="mx-2">/</span></li>
                        <li class="font-bold">Edit Produk</li>
                    </ul>
                </div>
        </div>
        ...
        <div class="flex justify-center my-6">
            <div class="flex flex-col rounded-md w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y">
                <div class="p-4 bg-gray-100 rounded-full">
                    <h1 class="ml-2 font-bold uppercase">Edit Stok Produk</h1>
                </div>
                <p class="text-xl mt-4 p-4 font-bold">{{ $product->name }}</p>
                ...
                <div class="flex mt-2 p-4 items-center pb-5 border-gray-200 mb-5">
                            ...
                            <div class="text-right mt-3">
                                <a href="{{ route('admin-product') }}" class="mx-2 inline-flex justify-center px-10 py-2 w-56 text-white font-semibold bg-red-900 hover:bg-red-800 rounded-md shadow-sm"> <i class="fas fa-arrow-left"></i>&nbspBack</a>
                                <button type="submit" class="inline-flex justify-center mx-2 px-10 py-2 w-56 text-white font-semibold bg-green-500 hover:bg-green-800 rounded-md shadow-sm"> <i class="fas fa-save"></i>&nbspUbah Produk</button>
                            </div>
                </form>
            </div>
        </div>
