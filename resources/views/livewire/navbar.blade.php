...
<div class="w-full bg-blue-900">
    <div x-data="{ open: false }"
        ...
        <div class="p-4 flex flex-row items-center justify-between">
            ...
            <div @click.away="open = false" class="mb-1 mr-4 relative" x-data="{ open: false }">
                <button @click="open = !open"
                    class="text-white w-full px-4 py-2 mt-2 text-sm font-semibold text-left bg-transparent rounded-lg   md:block hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
                    <span>List-Jersey</span>
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                    ...
                    class="z-10 absolute right-0 w-full mt-2 origin-top-right rounded-md shadow-lg">
